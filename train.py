...
def make_data(datas):
    ...
    for data in datas:
        if data != '\n':
            data = data.strip()
            train_data = [i if i!='\n' else '<sep>' for i in data] + ['<sep>']
            temp_data.extend(train_data)
        if data == '\n':
...
class MyDataSet(Data.Dataset):
    ...
    def __getitem__(self,item):
        ...
        return {"decoder_input":decoder_input,"decoder_output":decoder_output,"decoder_input_len":decoder_input_len,"decoder_output_len":decoder_output_len}
...
if __name__ == '__main__':
    ...
    data_loader = Data.DataLoader(dataset,batch_size=batch_size,collate_fn=dataset.padding_batch,shuffle=True)
